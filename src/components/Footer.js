          ...
          <div className="col-md-3">
            <div className="div">
              ...
              <div className="d-flex justify-content-between px-2">
                <a href="https://www.linkedin.com/in/aishwarya-jadhav-081362121"  target="_blank"
                      rel="noopener noreferrer">
                  <FaLinkedinIn className="footer-icons" />
                </a>

                <a class="phone" href="tel:+918329763848" title="Phone"  target="_blank"
                      rel="noopener noreferrer" >
                  <FaPhone className="footer-icons" />
                </a>

                <a href="https://github.com/aishwaryaj20"  target="_blank"
                      rel="noopener noreferrer">
